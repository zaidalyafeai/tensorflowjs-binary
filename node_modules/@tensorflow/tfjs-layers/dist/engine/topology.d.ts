...
export declare class Node {
    ...
    outputShapes: Shape | Shape[];
    readonly id: number;
    constructor(config: NodeConfig, callArgs?: any);
...
export declare class Layer {
    ...
    protected invokeCallHook(inputs: Tensor | Tensor[], kwargs: any): void;
    ...
    protected addWeight(name: string, shape: Shape, dtype?: DType, initializer?: Initializer, regularizer?: Regularizer, trainable?: boolean, constraint?: Constraint): LayerVariable;
